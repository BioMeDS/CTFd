import{e as c,C as i,a as d}from"./main-BOoqZ4em.js";import{$ as e}from"../jquery-BT3bhPE2.js";function r(o){let l=e("input[data-challenge-id]:checked").map(function(){return e(this).data("challenge-id")}),a=l.length===1?"challenge":"challenges";c({title:"Delete Challenges",body:`Are you sure you want to delete ${l.length} ${a}?`,success:function(){const t=[];for(var n of l)t.push(i.fetch(`/userchallenge/api/challenges/${n}`,{method:"DELETE"}));Promise.all(t).then(s=>{window.location.reload()})}})}function u(o){let l=e("input[data-challenge-id]:checked").map(function(){return e(this).data("challenge-id")});d({title:"Edit Challenges",body:e(`
